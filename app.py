...
def map_display():
    ...
    folium.Marker([16.31796271270806, 80.43880920394956],  popup='<a target="_blank" href=http://localhost:5000/Guntur>Predict!</a>', tooltip= "Guntur").add_to(m)
    folium.Marker([14.469685257965102, 78.82439366455279], popup='<a target="_blank" href=http://localhost:5000/Kadapa>Predict!</a>', tooltip= "Kadapa").add_to(m)
    folium.Marker([16.572103857283086, 80.85059936784116], popup='<a target="_blank" href=http://localhost:5000/Krishna>Predict!</a>', tooltip= "Krishna").add_to(m)
    folium.Marker([15.829016820646583, 78.03499797070828], popup='<a target="_blank" href=http://localhost:5000/Kurnool>Predict!</a>', tooltip= "Kurnool").add_to(m)
    folium.Marker([14.434108393791231, 79.98104886833782], popup='<a target="_blank" href=http://localhost:5000/Nellore>Predict!</a>', tooltip= "Nellore").add_to(m)
    folium.Marker([15.56634776682381, 79.55101034086451],  popup='<a target="_blank" href=http://localhost:5000/Prakasam>Predict!</a>', tooltip= "Prakasam").add_to(m)
    folium.Marker([16.196333585459023, 80.84786303681183], popup='<a target="_blank" href=http://localhost:5000/Srikakulam>Predict!</a>', tooltip= "Srikakulam").add_to(m)
    folium.Marker([17.695435246008262, 83.21449697148302], popup='<a target="_blank" href=http://localhost:5000/Visakhapatnam>Predict!</a>', tooltip= "Visakhapatnam").add_to(m)
    folium.Marker([18.106841627670757, 83.39686820653758], popup='<a target="_blank" href=http://localhost:5000/Vizianagaram>Predict!</a>', tooltip= "Vizianagaram").add_to(m)
    folium.Marker([16.871745407600862, 81.41923950492824], popup='<a target="_blank" href=http://localhost:5000/West_Godavari>Predict!</a>', tooltip= "West Godavari").add_to(m)
    m
